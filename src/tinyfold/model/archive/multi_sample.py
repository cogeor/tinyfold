...
Usage:
    from tinyfold.model.archive.multi_sample import MultiSampler, sample_centroids_multi

    # Wrap any existing sampler
    multi_sampler = MultiSampler(n_samples=5, aggregation="consensus")
    result = multi_sampler.sample(sample_fn, mask=mask)
"""
